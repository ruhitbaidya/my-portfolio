          ...
          <div className="mt-[20px]  rounded-lg">
            ...
            <div className="p-[20px]">
                <div className="grid grid-cols-4 gap-[25px]">
                    <div className=" p-[15px] text-center items-center flex-col">
                        <h2 className="text-[20px] font-[700] text-gray-700">Name</h2>
                        <p className="text-gray-700 text-[600]">Ruhit Baidya</p>
                    </div>
                    <div className="  p-[15px] text-center items-center flex-col">
                        <h2 className="text-[20px] font-[700] text-gray-700">Email</h2>
                        <p className="text-gray-700 text-[600]">ruhitbaidya01@gmail.com</p>
                    </div>
                    <div className=" p-[15px] text-center items-center flex-col">
                        <h2 className="text-[20px] font-[700] text-gray-700">Date Of Birth</h2>
                        <p className="text-gray-700 text-[600]">31/03/1998</p>
                    </div>
                    <div className=" p-[15px] text-center items-center flex-col">
                        <h2 className="text-[20px] font-[700] text-gray-700">Location</h2>
